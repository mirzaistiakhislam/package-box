...
const AvailableOrders = ({ selectedStartDate, setSelectedStartDate, selectedEndDate, setSelectedEndDate }) => {
    ...
    return (
        <section className='my-16'>
            <p className='text-center text-secondary font-bold'>Available Orders on {format(selectedStartDate, 'PP')} to {format(selectedEndDate, 'PP')} </p>
            <div className='my-16 grid gap-6'>
                {/* grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-6 */}
                {
